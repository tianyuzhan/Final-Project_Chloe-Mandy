...
The sum of square error (SSE) scree plot also shows that cluster=2 is the significant bend. Both methods suggest k=2 is the best, but as there are 3 types in iris, we continue to try 2 and 3 clusters respectively.
...
Also, it's noticeable that the two clustering number give very different results.
...
After scaling, ARI drops to 0.62. K-means seems not a good classfication method for iris and the scaling doesn't help at all.
